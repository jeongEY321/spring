...
public class KakaoService {
	...
	public String getAuthorizationUrl(HttpSession session) {
		...
		String requestUrl = String.format("https://kauth.kakao.com/oauth/authorize?client_id=%s&redirect_uri=%s&response_type=code&prompt=login&state=%s", kakaoClientId, redirectUri, state);
    ...
    public KakaoUserVO getUserProfile(String accessToken) {
        ...
        headers.add(accessToken, requestUri);
