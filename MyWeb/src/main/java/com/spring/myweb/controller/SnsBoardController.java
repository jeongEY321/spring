...
public class SnsBoardController {
	...
	@PostMapping("/upload")
	public String upload(MultipartFile file, SnsBoardVO vo) { // 이미지는 file로 오고 writer content는 vo로
	...
	/*
	 ...
	 img 태그의 src에 작성된 요청 url을통해 자동으로 요청이 들어오게 됩니다.
	 요청을 받아주는 메서드를 선언하여 경로에 지정된 파일을 보낼 예정입니다.
	 */
	@GetMapping("/display/{fileLoca}/{fileName}")
	public ResponseEntity<byte[]> GetField(@PathVariable String fileLoca,
